...
public class DetailSearchActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        icon.setImageDrawable(context.getResources().getDrawable(R.drawable.ic_action_content_add));
        ...
        itemIcon.setImageDrawable(context.getResources().getDrawable(R.drawable.ic_call_black_24dp));
        SubActionButton button1 = itemBuilder.setContentView(itemIcon).build();

        itemIcon = new ImageView(this);
        itemIcon.setImageDrawable(context.getResources().getDrawable(R.drawable.ic_place_black_24dp));
        ...
        button1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                //Toast.makeText(DetailSearchActivity.this, tel, Toast.LENGTH_SHORT).show();
        ...
        button2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                //Toast.makeText(DetailSearchActivity.this, map, Toast.LENGTH_SHORT).show();
    ...
    public void navigationBarStatusBar() {
        ...
        if (getResources().getConfiguration().orientation == Configuration.ORIENTATION_PORTRAIT) {
            if (Build.VERSION.SDK_INT >= 19) {
                ...
                DetailSearchActivity.this.getTheme().resolveAttribute(R.attr.colorPrimary, typedValue19, true);
            ...
            if (Build.VERSION.SDK_INT >= 21) {
                ...
                DetailSearchActivity.this.getTheme().resolveAttribute(R.attr.colorPrimaryDark, typedValue21, true);
        ...
        if (getResources().getConfiguration().orientation == Configuration.ORIENTATION_LANDSCAPE) {
            ...
            if (Build.VERSION.SDK_INT >= 21) {
                ...
                DetailSearchActivity.this.getTheme().resolveAttribute(R.attr.colorPrimaryDark, typedValue, true);
